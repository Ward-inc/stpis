...
public class hrControllerTest {
    ...
    @MockBean
    private demolab.stpiss.repo.personRepo personRepo;
    @MockBean
    private demolab.stpiss.repo.hrRepo hrRepo;
    @Autowired
    ...
    @Test
    void hrCourse() throws Exception {

        hrCourseTemplate devOrder = new hrCourseTemplate(1L,1L);


        mockMvc.perform(post("/hr/getcourse")
                        .content(objectMapper.writeValueAsString(devOrder))
                        .contentType(MediaType.APPLICATION_JSON)
                )
                .andDo(print())
